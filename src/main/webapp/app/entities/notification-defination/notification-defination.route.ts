...
export class NotificationDefinationResolve implements Resolve<INotificationDefination> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<INotificationDefination> {
...
export const notificationDefinationRoute: Routes = [
    {
        ...
        data: {
            ...
            defaultSort: 'id,asc',
            pageTitle: 'notificationApp.notificationDefination.home.title'
        },
