...
export class SystemNotificationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.systemNotificationService
            ...
            .subscribe(
                (res: HttpResponse<ISystemNotification[]>) => this.paginateSystemNotifications(res.body, res.headers),
    ...
    trackId(index: number, item: ISystemNotification) {
        return item.id;
    }
    ...
    protected paginateSystemNotifications(data: ISystemNotification[], headers: HttpHeaders) {
