...
import com.edigitpath.notification.service.SourceTypeService;
import com.edigitpath.notification.domain.SourceType;
import com.edigitpath.notification.repository.SourceTypeRepository;
...
public class SourceTypeServiceImpl implements SourceTypeService {
    ...
    public void delete(Long id) {
        log.debug("Request to delete SourceType : {}", id);        sourceTypeRepository.deleteById(id);
    }
}
