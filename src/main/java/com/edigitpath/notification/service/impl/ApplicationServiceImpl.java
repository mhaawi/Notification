...
import com.edigitpath.notification.service.ApplicationService;
import com.edigitpath.notification.domain.Application;
import com.edigitpath.notification.repository.ApplicationRepository;
...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    public void delete(Long id) {
        log.debug("Request to delete Application : {}", id);        applicationRepository.deleteById(id);
    }
}
