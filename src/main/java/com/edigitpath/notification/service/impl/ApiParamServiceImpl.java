...
import com.edigitpath.notification.service.ApiParamService;
import com.edigitpath.notification.domain.ApiParam;
import com.edigitpath.notification.repository.ApiParamRepository;
...
public class ApiParamServiceImpl implements ApiParamService {
    ...
    public void delete(Long id) {
        log.debug("Request to delete ApiParam : {}", id);        apiParamRepository.deleteById(id);
    }
}
