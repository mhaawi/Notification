...
import com.edigitpath.notification.service.NotificationDefinationService;
import com.edigitpath.notification.domain.NotificationDefination;
import com.edigitpath.notification.repository.NotificationDefinationRepository;
...
public class NotificationDefinationServiceImpl implements NotificationDefinationService {
    ...
    public void delete(Long id) {
        log.debug("Request to delete NotificationDefination : {}", id);        notificationDefinationRepository.deleteById(id);
    }
}
