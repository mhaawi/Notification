...
import com.edigitpath.notification.service.ApiDefinationService;
import com.edigitpath.notification.domain.ApiDefination;
import com.edigitpath.notification.repository.ApiDefinationRepository;
...
public class ApiDefinationServiceImpl implements ApiDefinationService {
    ...
    public void delete(Long id) {
        log.debug("Request to delete ApiDefination : {}", id);        apiDefinationRepository.deleteById(id);
    }
}
