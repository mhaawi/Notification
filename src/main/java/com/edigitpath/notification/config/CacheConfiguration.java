package com.edigitpath.notification.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.edigitpath.notification.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.edigitpath.notification.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            cm.createCache(com.edigitpath.notification.domain.NotificationDefination.class.getName() + ".applications", jcacheConfiguration);
            cm.createCache(com.edigitpath.notification.domain.NotificationDefination.class.getName() + ".apiDefinations", jcacheConfiguration);
