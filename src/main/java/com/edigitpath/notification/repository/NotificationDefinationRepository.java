...
import com.edigitpath.notification.domain.NotificationDefination;
...
public interface NotificationDefinationRepository extends JpaRepository<NotificationDefination, Long> {
    ...
    @Query(value = "select distinct notification_defination from NotificationDefination notification_defination left join fetch notification_defination. left join fetch notification_defination.",
    ...
    @Query("select notification_defination from NotificationDefination notification_defination left join fetch notification_defination. left join fetch notification_defination. where notification_defination.id =:id")
