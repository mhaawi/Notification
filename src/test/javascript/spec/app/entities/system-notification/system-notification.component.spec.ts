...
import { SystemNotificationComponent } from 'app/entities/system-notification/system-notification.component';
...
describe('Component Tests', () => {
    describe('SystemNotification Management Component', () => {
        let comp: SystemNotificationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SystemNotificationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new SystemNotification(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.systemNotifications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
